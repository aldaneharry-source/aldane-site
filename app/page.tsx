export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#050B14] text-white">
      ...
      <div className="mb-12 text-center">
        <div className="mx-auto mb-4 h-1 w-20 bg-blue-500"></div>
          <h2 className="text-3xl font-bold md:text-5xl">Pricing</h2>
        <p className="mx-auto mt-4 max-w-2xl text-slate-400">
          Simple starting prices for businesses that need a professional digital presence.
...
>
      <div className="mb-12 text-center">
        <div className="mx-auto mb-4 h-1 w-20 bg-blue-500"></div>
          ...
          Ready to build your website or system? Send us a message and we’ll get back to you.
          </p>
      </div>
      ...
      <div className="grid gap-12 md:grid-cols-2">
        ...
        <p className="mb-6 text-slate-300">
          Reach out to discuss your project, ask questions, or request a quote.
        </p>
    ...
    {/* RIGHT SIDE FORM */}
    <form className="rounded-xl border border-slate-800 bg-slate-900/70 p-6 space-y-4">
      <div>
